...
>Defines the various prompts used by Digi to amend a user’s prompts prior to engaging the AI.  
  ...
  * Request Action - (optional) REF to a row in the Action table.  The nature of the users request may impact what prompts are amended to the user’s prompt.  If empty this row applies to ALL actions!   See “Configuring” notes below.  
  8 Type - the type of amendment (prefix, postfix, format, source).   
...
* Starcoder in a box  
* IaC for a plug and play Starcoder stack that you can push to your safest subnet and integrate with to train your sensitive data behind your very own firewalls.  
* Test Driven Development:  
  * Give Digi an ATF Test and have it freely build a solution on the platform until the test passes.  
* AI Actions  
